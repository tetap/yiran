;!function (win) {
  ...
  Xadmin.prototype.end = function() {
	...
	Xadmin.prototype.add_tab = function (title,url,pname,is_refresh) {
        ...
        this.set_data(title, url, id, pname);
	    element.tabChange('xbs_tab', id);
  ...
  Xadmin.prototype.father_reload = function() {
	 ...
	 */
    Xadmin.prototype.set_data = function (title, url, id, pname) {
		...
		layui.data('tab_list', {
		  key: id
		  ,value: {title:title,url:url,pname:pname}
		});
	};
